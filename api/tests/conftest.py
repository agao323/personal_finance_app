...
from app.db import Base, get_engine, get_session, get_sessionmaker
...
def engine() -> Iterator[Engine]:
    ...
    # TODO(009): replace with `alembic upgrade head` once migrations exist, so that a
    # broken migration fails the suite instead of shipping green.
